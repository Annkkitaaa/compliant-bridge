...
var onCronTrigger = (runtime2) => {
  runtime2.log("Compliance Check Workflow initialized");
  runtime2.log(`API Base URL: ${runtime2.config.complianceApiBaseUrl}`);
  runtime2.log(`EVM targets: ${runtime2.config.evms.length}`);
